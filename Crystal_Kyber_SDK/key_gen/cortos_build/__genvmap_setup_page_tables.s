...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=25, level=3,  ppnr=0x19000, p_addr=0x64, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x64) = 0x190e (pte)
   set 0x190e, %g2
   set 0x64, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=27, level=3,  ppnr=0x1b000, p_addr=0x6c, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x6c) = 0x1b92 (pte)
   set 0x1b92, %g2
   set 0x6c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=30, level=3,  ppnr=0x1e000, p_addr=0x78, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x78) = 0x1e92 (pte)
   set 0x1e92, %g2
   set 0x78, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
